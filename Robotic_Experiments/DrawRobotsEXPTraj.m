%% Visualize the trajectory of robotic experiments for BOC-based interaction and Vicsek interaction.
clear;clc;
addpath("../Data/Robots Data/")
addpath("../Utility/")
load("trajectory_cell_BOC.mat")
load("trajectory_cell_Vicsek.mat")
DrawTraj(trajectory_cell_BOC{10});
DrawTraj(trajectory_cell_Vicsek{5});
